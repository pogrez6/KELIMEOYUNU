...
void random_sayi_oyunbiricin(int arraybir[3]);//4 harfli kelimelerden rastgele bir harf okumak için
...
void oyun_kurallari()
{
    ...
    printf("\n\t\t\t\t\t\t\tAD=ERAY DURSUN OGR_NO=171307014");
    printf(" \n \n   TOPLAM SÜRENÝZ 240 Saniye (4 dakika)'dir  ");
    return ;
}
...
void random_sayi_oyunbiricin(int arraybir[3])
{
    int x, p;
    int count;
    int i=0;
...
int main()
{
    ...
    float total_s;
    char cevap[10];
    int arraybir[3],array1[4],array2[5],array3[6],array4[7],array5[8],array6[9],arrayx[2];
    //süreyi baþlattým.
    clock_t t0 = clock();
//-------------------------------------------------------------------------------------------------------------------------------------------------
    //1. oyun
    ...
    dongu=0;
    random_sayi_(arrayx);
    random_sayi_oyunbiricin(arraybir);
    ...
    for(int a=0;a<2;a++)
    {
        ...
        for(int z=0;z<10;z++)
        {
            ...
            if(arrayx[say+1]==z&&dongu!=2)
            {
                ...
                do
                {
                    //cevap doðru oalna kadar dönecek döngü
                    printf("\n\ncevabý giriniz= ");
                    gets(cevap);
                            ...
                            else if(result1==0)
                            {
                                if(sayac!=3)
                                {
                                    ...
                                    for(int i=0;i<k;i++)
                                    {
                                        if(i==c)
                                        {
                                            //verilen harfi gidip yerine yazar
    ...
    clock_t t1 = clock();
    total_s=(240-((double)(t1 - t0)/CLOCKS_PER_SEC));
...
//-------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    // 4 harfli kelimelerden iki tanesini ni sorularý ile sordurmak için for loop
    say=0;
    dongu=0;
    random_sayi_(arrayx);
